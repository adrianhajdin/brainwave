...
export const pricing = [
  {
    ...
    description: "Monthly prices per office. Prices coming soon.",
    price1: "2 Kiosks",
    price2: "3 Kiosks",
    price3: "Extra: $ each",
    features: [
      "Every kiosk includes one user (agent, admin or both)",
      "For each extra user you will pay $ more per month",
      "Initial fee per office + extra costs (if needed)",
    ],
  },
  {
    id: "1",
    title: "Full VideFace",
    description: "VideFace Calls + VideFace Cars and more! Prices coming soon.",
  ...
  },
  {
    id: "2",
    title: "VideFace Cars",
    description: "Monthly prices for all cars. Prices coming soon.",
    price1: "200 Cars",
    price2: "300 Cars",
    price3: "Every 100+ for $",
    features: [
      "Full control of your cars, damages, photos and more",
      "Car Inspection Service included in this plan",
      "One global initial fee for all your cars",
    ],
  },
];
